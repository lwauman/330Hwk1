...
public class lwauman_hwk1{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("        True Expected");
        System.out.println("Integer Array (true expected).  Result: "+contains(arr, new PerfectSquare()));
        System.out.println("Double Array (true expected).   Result: "+contains(arr3, new PerfectSquare()));
        System.out.println("Long Array (true expected).     Result: "+contains(arr5, new PerfectSquare()));
        System.out.println("Byte Array (true expected).     Result: "+contains(arr7, new PerfectSquare()));
        System.out.println("Short Array (true expected).    Result: "+contains(arr9, new PerfectSquare()));
        System.out.println("Float Array (true expected).    Result: "+contains(arr11, new PerfectSquare()));
        System.out.println("int Array(true expected).       Result: "+contains(arr14, new PerfectSquare()));
        System.out.println("            False Expected");
        System.out.println("Integer Array (false expected). Result: "+contains(arr2, new PerfectSquare()));
        System.out.println("Double Array (false expected).  Result: "+contains(arr4, new PerfectSquare()));
        System.out.println("Long Array (false expected).    Result: "+contains(arr6, new PerfectSquare()));
        System.out.println("Byte Array (false expected).    Result: "+contains(arr8, new PerfectSquare()));
        System.out.println("Short Array (false expected).   Result: "+contains(arr10, new PerfectSquare()));
        System.out.println("Float Array (false expected).   Result: "+contains(arr12, new PerfectSquare()));
        System.out.println("String Array (false expected).  Result: "+contains(arr13, new PerfectSquare()));
        System.out.println("int Array(false expected).      Result: "+contains(arr15, new PerfectSquare()));
        System.out.println("");
        System.out.println("        Contains Prime Tests");
        System.out.println("            True Expected");
        System.out.println("Integer Array (true expected).  Result: "+contains(arr, new Prime()));
        System.out.println("Double Array (true expected).   Result: "+contains(arr3, new Prime()));
        System.out.println("Long Array (true expected).     Result: "+contains(arr5, new Prime()));
        System.out.println("Byte Array (true expected).     Result: "+contains(arr7, new Prime()));
        System.out.println("Short Array (true expected).    Result: "+contains(arr9, new Prime()));
        System.out.println("Float Array (true expected).    Result: "+contains(arr11, new Prime()));
        System.out.println("int Array(true expected).       Result: "+contains(arr14, new Prime()));
        System.out.println("            False Expected");
        System.out.println("Integer Array (false expected). Result: "+contains(arr2, new Prime()));
        System.out.println("Double Array (false expected).  Result: "+contains(arr4, new Prime()));
        System.out.println("Long Array (false expected).    Result: "+contains(arr6, new Prime()));
        System.out.println("Byte Array (false expected).    Result: "+contains(arr8, new Prime()));
        System.out.println("Short Array (false expected).   Result: "+contains(arr10, new Prime()));
        System.out.println("Float Array (false expected).   Result: "+contains(arr12, new Prime()));
        System.out.println("String Array (false expected).  Result: "+contains(arr13, new Prime()));
        System.out.println("int Array(false expected).      Result: "+contains(arr15, new Prime()));
    }
}
